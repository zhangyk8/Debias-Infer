...
for(i in 0:3){
  ...
  for(k in 0:2){
    ...
    lproj_res = data.frame(m_obs1 = m_rproj_obs1, ci_len_obs1 = ci_len_rproj_obs1, 
    ...
    write.csv(lproj_res, paste0("./lproj_res/lproj_equicor_d", d, "_n", n, "_", jobid, "_x", i, "_beta", k, ".csv"), 
              row.names=FALSE)
  }
}
