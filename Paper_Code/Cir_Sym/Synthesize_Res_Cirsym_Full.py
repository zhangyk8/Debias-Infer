...
Description: Synthesize the slurm array results.
"""
...
# for b in range(1, B+1):
#     try:
#         lproj = pd.read_csv('./lproj_res/lproj_res_d'+str(d)+'_n'+str(n)+'_'+str(b)+'_x1.csv')
#         lproj_res1 = pd.concat([lproj_res1, lproj])
#     except:
#         print(b)
#         continue
# lproj_res1.to_csv('lproj_res_d'+str(d)+'_n'+str(n)+'_x1.csv', index=False)
