...
Description: Obtaining the Lasso pilot estimates (circulant symmetric covariance 
case).
"""
...
for i in range(6):
    ...
    for k in range(3):
        ...
        for error in ['gauss', 'laperr', 'terr', 'uniferr']:
            ...
            pilot_res1.to_csv('./pilot_res/lasso_pilot_Cirsym_d'+str(d)+'_n'+str(n)+'_'+str(job_id)+\
