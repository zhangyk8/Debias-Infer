...
(https://arxiv.org/pdf/2406.13906) (circulant symmetric covariance with Gaussian noises)
"""
...
for i in range(6):
    ...
    for k in range(3):
        ...
        save_same_format(out_dir, f"Tian2024_CirSym_cov_homoerr_d{d}n{n}_MCAR", job_id, i, k, res1)

        save_same_format(out_dir, f"Tian2024_CirSym_cov_homoerr_d{d}n{n}_MAR", job_id, i, k, res2)