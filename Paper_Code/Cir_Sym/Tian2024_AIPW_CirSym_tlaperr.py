...
(https://arxiv.org/pdf/2406.13906) (circulant symmetric covariance 
...
for i in range(6):
    ...
    for k in range(3):
        for err in ['terr', 'laperr']:
            ...
            save_same_format(out_dir, f"Tian2024_CirSym_cov_homoerr_d{d}n{n}_MCAR_{err}", job_id, i, k, res1)

            save_same_format(out_dir, f"Tian2024_CirSym_cov_homoerr_d{d}n{n}_MAR_{err}", job_id, i, k, res2)