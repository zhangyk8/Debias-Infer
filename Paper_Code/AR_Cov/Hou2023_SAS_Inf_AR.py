...
(https://www.jmlr.org/papers/volume24/21-1075/21-1075.pdf) (Toeplitz covariance AR(1) with Gaussian noises)
"""
...
for i in range(6):
    ...
    for k in range(3):
        ...
        save_same_format(out_dir, f'Hou2023_SAS_AR_cov_homoerr_d{d}n{n}_MCAR', job_id, i, k, res1)
        save_same_format(out_dir, f'Hou2023_SAS_AR_cov_homoerr_d{d}n{n}_MAR', job_id, i, k, res2)
